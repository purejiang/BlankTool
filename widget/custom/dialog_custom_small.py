...
class SmallCustomDialog(BaseDialog):
    """
    ...
    """
    __UI_FILE = "./res/ui/dialog_custom_small.ui"
    __QSS_FILE = "./res/qss/dialog_custom_small.qss"

    def __init__(self, parent) -> None:
        super(SmallCustomDialog, self).__init__(parent, self.__UI_FILE, self.__QSS_FILE)
        self.__title = None
    ...
    def _setupListener(self):
        self._ui.btn_dialog_small_confirm.clicked.connect(self.__onConfirm)
        self._ui.btn_dialog_small_cancel.clicked.connect(self.__onCancel)
        self._ui.btn_dialog_small_close.clicked.connect(self.__onClose)
    ...
    def title(self, value):
        self.__title = value
        self._ui.lb_dialog_small_title.setText(value)
    ...
    def content_widget(self, value):
        ...
        self._ui.layout_dialog_small_main.addWidget(value)
    
    def setCancelListener(self, str, listener, is_show=True):
        self.__cancel_listener= listener
        self._ui.btn_dialog_small_cancel.setText(str)
        self._ui.btn_dialog_small_cancel.setVisible(is_show)

    def setConfirmListener(self, str, listener, is_show=True):
        self.__confirm_listener= listener
        self._ui.btn_dialog_small_confirm.setText(str)
        self._ui.btn_dialog_small_confirm.setVisible(is_show)
    
    def setCloseListener(self, listener, is_show=True):
        self.__close_listener = listener
        self._ui.btn_dialog_small_close.setVisible(is_show)
